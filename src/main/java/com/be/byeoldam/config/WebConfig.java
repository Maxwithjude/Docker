...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://localhost:8080", "http://frontend:3000","http://frontend:5173","http://127.0.0.1:8080", "http://localhost:5173", "http://localhost:5174", "chrome-extension://djiemmdlekojnbiclbgdepjapkoejddm") // Swagger UI와 관련된 Origin 허용
