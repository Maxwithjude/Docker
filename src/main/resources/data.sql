-- 유저 더미 데이터
INSERT INTO user (id, email, password, nickname, role, profile_url, is_verified, is_active, provider, alert_day)
VALUES
    (1, 'user1@example.com', 'password1', 'User1', 'ROLE_USER', 'https://example.com/default-profile.png', true, 'ACTIVE', 'LOCAL', 7),
    (2, 'user2@example.com', 'password2', 'User2', 'ROLE_USER', 'https://example.com/default-profile.png', true, 'ACTIVE', 'LOCAL', 3),
    (3, 'user3@example.com', 'password3', 'User3', 'ROLE_USER', 'https://example.com/default-profile.png', true, 'ACTIVE', 'LOCAL', 5);
...
-- 태그 더미 데이터
INSERT INTO tag (id, name, reference_count, color)
VALUES
    (1, 'IT', 2, 'PASTEL_BLUE'),
    (2, '개발', 1, 'PASTEL_GREEN'),
    (3, '디자인', 1, 'PASTEL_PINK');
...
VALUES
    ...
    (2, 2, NULL, 1, 'INVITE', '공유 컬렉션 A에 초대되었습니다.', NOW(), 'User1', NOW());
