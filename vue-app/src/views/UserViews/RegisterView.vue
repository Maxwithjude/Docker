<template>
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-4 py-4 mx-auto w-full max-w-sm h-auto md:h-[80vh] lg:py-2">

            <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-8 h-8 mr-2" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/logo.svg" alt="logo">
                별담
            </a>
            <!-- 수정된 부분: max-w-sm으로 변경하고 mx-auto 추가 -->
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xs mx-auto xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">약관에 동의합니다. <a class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">약관 보기</a></label>
                            </div>
                        </div>
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            이미 계정이 있으신가요? <a href="/login" class="font-medium text-primary-600 hover:underline dark:text-primary-500">로그인 하러가기</a>
                        </p>
                    </form>
                </div>
            </div>
